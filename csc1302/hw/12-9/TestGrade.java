...
public class TestGrade {
    public static void main(String args[]) throws Exception {
       ...
       try
         {
             flag = 0;
             for(int y = 0; y < GradeException.VALID_ALPHA_GRADES.length; ++y)
             {
                if(grades[x] == GradeException.VALID_ALPHA_GRADES[y])
                    flag = 1;
             }
             if(flag == 0)
             {
...
// i'm fixing this in vscode i can't read this
// i didn't cheat during this assignment. 
